<template>
  <div class="signup-form">
    ...
    <!-- <p class="hint-text">Create your account. It's free and only takes a minute.</p> -->
      ...
      <div class="form-group">
        <input type="text" class="form-control" name="name" placeholder="Name" required="required"></div>
        </div> -->
        <div class="form-group">
  ...
  <div class="text-center">Already have an account? <a href="#" style="text-decoration:none; color:blue">Sign in</a></div>
</div>
</template>
