        ...
        <div class ="col">
          ...
          <div class ="tombol" style="text-align:center;" >
                ...
                <button type="button" class="btn btn-info">
                  <router-link to="/admin">Back</router-link></button>
          </div>
          </div>
        </div>
      </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" v-if="productEdit">
                    <form v-on:submit.prevent="editProduct">
                        ...
                        <input type="text" v-model="productEdit.name" class="form-control"
                        id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Name">
                        </div>
                        <div class="form-group" >
                        <label for="exampleInputPassword1">Image Url</label>
                        <input type="text" v-model="productEdit.image_url" class="form-control"
                         placeholder="Image Url">
                        </div>
                        <div class="form-group" >
                        <label for="exampleInputPassword1">Price</label>
                        <input type="text" v-model="productEdit.price" class="form-control"
                         placeholder="Price">
                        </div>
                        <div class="form-group" >
                        <label for="exampleInputPassword1">Stock</label>
                        <input type="text" v-model="productEdit.stock" class="form-control"
                         placeholder="Stock">
                        </div>
                         <div class="form-group">
