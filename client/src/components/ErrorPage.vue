<template>
  <div class="container">
    ...
    <div class="terminal">
      <p class="prompt">You dont have any Cart right now meow. Try typing 'kittens'.</p>
  ...
  mounted() {
    ...
    function showKittens() {
      ...
      setTimeout(function() {
        ...
        $.get(
          "http://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=kittens",
          function(result) {
            gif = result.data.image_url;
            $(".terminal").append(
              '<img class="kitten-gif" src="' + gif + '"">'
            );
            resetForm(true);
          }
        );
