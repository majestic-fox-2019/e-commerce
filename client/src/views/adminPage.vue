<template>
  ...
  <div>
    <nav class="main-menu">
      ...
      <ul>
        <router-link class="link" :to="{ name: 'productTable' }">
          <li>
            <a>
        ...
        <li class="link" data-toggle="modal" data-target="#addProduct">
          <a>
        ...
        <li class="link" data-toggle="modal" data-target="#addCategory">
          <a>
            <i class="fa fa-plus fa-2x"></i>
