  ...
  <b-container class="mt-5 p-5" id="detailMain">
    ...
    <b-row class="prodPic-priceStock">
        ...
        <b-col class="test" id="priceStock">
            ...
            <div class="my-3" id="qty" v-if="$store.state.userInfo && $store.state.displayDetail.stock && $store.state.userInfo.role !== 'admin' && $store.state.displayDetail.UserId !== $store.state.userInfo.id">
            ...
            <div class="mt-4" v-if="$store.state.userInfo">
                <b-button v-if="$store.state.displayDetail.stock > 0 && $store.state.userInfo.role !== 'admin' && $store.state.displayDetail.UserId !== $store.state.userInfo.id" @click.prevent="addToCart($store.state.displayDetail.id)">Add to Cart</b-button>
